...
rsync -avhzxAXPR --chmod=Du=rwx,Dgo=rx,Fu=rw,Fgo=r --delete --fake-super --stats --log-file=/deepstorage/Backups/rsync-`cat /deepstorage/Backups/time.txt`.log --exclude-from ~/Scripts/rsync_snapshot_exclude.txt --link-dest=/deepstorage/Backups/`cat /deepstorage/Backups/time2.txt` /home /deepstorage/Backups/`cat /deepstorage/Backups/time.txt`
